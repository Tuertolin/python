...
city = st.sidebar.text_input("Enter city name:", "Sydney")
get_weather = st.sidebar.button("Get Weather", key="weather_btn")

st.sidebar.divider()

# Stock inputs in sidebar
st.sidebar.subheader("Stock Settings")
ticker = st.sidebar.text_input("Enter stock ticker:", "CBA.AX", 
                      help="For Australian stocks, add .AX (e.g., CBA.AX, BHP.AX)")
days = st.sidebar.slider("Select number of days:", 7, 90, 30)
get_stock = st.sidebar.button("Get Stock Data", key="stock_btn")
...
with col1:
    ...
    if get_weather:
        ...
        st.info("👈 Enter a city name in the sidebar and click 'Get Weather' to see weather data")
...
with col2:
    ...
    if get_stock:
        ...
        st.info("👈 Enter a stock ticker in the sidebar and click 'Get Stock Data' to see stock information")

# ===== FOOTER =====
st.divider()
st.caption("Dashboard updates in real-time when you click the buttons in the sidebar")
